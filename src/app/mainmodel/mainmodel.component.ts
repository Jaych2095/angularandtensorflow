...
@Component({
  selector: 'app-mainmodel',
  templateUrl: './mainmodel.component.html',
  styleUrls: ['./mainmodel.component.css']
})
export class MainmodelComponent implements OnInit {
  ...
  private title = ''
  private predicted = '';
  constructor(private sharedservice:PostService,private router:Router,private toaster:NotificationService) { }
